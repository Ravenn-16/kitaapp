...
<link rel="stylesheet" href="<?php echo e(asset('styles.css')); ?>?v=<?php echo e(filemtime(public_path('styles.css'))); ?>">
<script src="<?php echo e(asset('support.js')); ?>"></script>
  ...
  <div class="auth-card auth-card--login">
    ...
    <div class="auth-card__body">
      <div class="auth-header">
        <img src="<?php echo e(asset('images/kita-logo.jpg')); ?>" alt="KITA - Money. Managed. Smarter." class="kita-logo" width="200" height="200">
...
<script>window.KITA_DATA_URL = "<?php echo e(url('/api/kita-data')); ?>";</script>
<script>
window.KITA_AUTH = {
  loginError: <?php echo e(Illuminate\Support\Js::from(session('login_error', ''))); ?>,
  user: <?php echo e(Illuminate\Support\Js::from(auth()->user()?->only(['id', 'name', 'email', 'role']))); ?>,
  loginUrl: "<?php echo e(route('login')); ?>",
  transactionUrl: "<?php echo e(route('transactions.store')); ?>",
  paymongoUrl: "<?php echo e(route('paymongo.checkout')); ?>",
  logoutUrl: "<?php echo e(route('logout')); ?>",
  csrfToken: "<?php echo e(csrf_token()); ?>"
};
</script>
<script type="text/x-dc" data-dc-script src="<?php echo e(asset('app.js')); ?>?v=<?php echo e(filemtime(public_path('app.js'))); ?>"></script>
</body>
</html>
<?php /**PATH C:\Users\ASUS TUF\Music\kita-laravel\resources\views/kita.blade.php ENDPATH**/ ?>